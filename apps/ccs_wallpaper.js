...
export class Jinmaocuicuisha_wallpaper extends plugin {
  constructor () {
    super({
      ...
      rule: [
        //------------------------------------------------------------------------//  ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 131-209行
         //   横版壁纸      横版壁纸      横版壁纸      横版壁纸      横版壁纸      //    ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 131-209行
          //   横版壁纸       横版壁纸      横版壁纸      横版壁纸      横版壁纸   //       ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 131-209行   
           //    横版壁纸       横版壁纸      横版壁纸      横版壁纸      横版壁纸//          ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 131-209行
            //----------------------------------------------------------------//             ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 131-209行
              {
        ...
        //-----------------------------------------------------------------------//  
         //   竖版图片      竖版图片      竖版图片      竖版图片      竖版图片     //    ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 215-243行
          //   竖版图片      竖版图片     竖版图片      竖版图片      竖版图片   //       ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 215-243行
           //   竖版图片      竖版图片      竖版图片     竖版图片      竖版图片 //          ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 215-243行
            //---------------------------------------------------------------//             ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 215-243行
            {
        ...
        //-----------------------------------------------------------------------//  ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 248-306行
         //   其他照片      其他照片     其他照片      其他照片      其他照片     //    ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 248-306行
          //   其他照片      其他照片     其他照片      其他照片      其他照片   //       ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 248-306行
           //   其他照片      其他照片     其他照片      其他照片      其他照片 //         ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 248-306行
            //--------------------------------------------------------------//            ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 248-306行
              {
              ...
              {
                reg: "^#?(真寻|欧尼|zx|ZX|Zx|zX)(酱|j|J)?(照片|zp|ZP|Zp|zP)$",
                fnc: '真寻照片'
              },
        //-----------------------------------------------------------------------//  ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 312-340行
         //   美图美图      美图美图     美图美图      美图美图      美图美图     //     ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 312-340行
          //   美图美图      美图美图     美图美图      美图美图      美图美图   //       ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 312-340行
           //   美图美图      美图美图     美图美图      美图美图      美图美图 //         ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 312-340行
            //---------------------------------------------------------------//           ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 312-340行
              {
                reg: "^#?(小姐姐)(美图|mt|MT|Mt|mT)$",
                fnc: '小姐姐美图'          
              }, 
              {
        ...
        //-----------------------------------------------------------------------//  ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 346-353行
         //   扩展帮助      扩展帮助     扩展帮助      扩展帮助      扩展帮助     //     ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 346-353行
          //   扩展帮助      扩展帮助     扩展帮助      扩展帮助      扩展帮助   //       ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 346-353行
           //   扩展帮助      扩展帮助     扩展帮助      扩展帮助      扩展帮助 //         ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 346-353行
            //---------------------------------------------------------------//           ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓ 346-353行
              {
