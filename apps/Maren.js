...
const tplb_path=path+'/plugins/Jinmaocuicuisha-plugin/Cfg/Ciku/骂人图片/';

let cd = false
let source={}
let MuteTime = 600; // 禁言时间秒(需bot管理员)
let tp_path='./plugins/Jinmaocuicuisha-plugin/Cfg/Ciku/词库.yaml'
let _path='./plugins/Jinmaocuicuisha-plugin/Cfg/Ciku/骂人图片/'
