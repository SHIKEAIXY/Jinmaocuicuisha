...
export const helpList = [
    ...
    {
      "icon": 116,
      "title": "`#打我``#打他`", "desc": "打我或者打他触发"
    }, 
    {
      "icon": 120,
      "title": "`#骰子``#重置骰子``#一到六``#开`", "desc": "输入一到六再发开来开启游戏"
    }
    ]
    },
    ...
    {
      "icon": 113,
      "title": "`#开启|关闭自动撤回``#本群(禁用|启用)自动撤回``#设置自动撤回时间S秒`", "desc": "自动撤回`"
    },
    {
      "icon": 114,
      "title": "`#写入|删除文字``#词库列表`", "desc": "里面没文字需要自己写"
    },
    {
      "icon": 126,
      "title": "`#上传|删除骂人图片``#骂人图片列表`", "desc": "里面没图片需要自己上传"
    }
    ]
    },
